...
GTD %>% 
  ...
  labs(title = "Palestinian Terrorists Weren't Deterred by the Hague Convention. They Changed Strategies.",
       ...
       caption = "Data: Global Terrorism Database. Note: GTD has missing data for all of 1993. It was easier to omit 1993 for the sake of this illustration.") +
  annotate("text", x = 1970, y = 20, 
           label = "Hague\nConvention\n(1970)",
           family = "Open Sans") +
  annotate("text", x = 1975, y = 20,
           label = "Metal detectors\nappear\n(1973)",
           family = "Open Sans")
```

...
WDI(country = "all", indicator = c("NY.GDP.PCAP.CD", "NY.GDP.PETR.RT.ZS"),
  ...
  mutate(oilround = mround2(oilrent/100),
         mediangdp = median(gdppc)) %>%
  ggplot(.,aes(reorder(country, -oilrent), oilrent)) + theme_steve_web() +
  geom_bar(stat="identity", alpha=0.8, color="black") +
  xlab("Country") + ylab("Oil Rents as Percentage of GDP") +
  labs(title = "These Are the Ten Countries Whose Economies Are Most Indebted to Selling Oil Abroad (2015)",
       subtitle = "There are some conspicuous states in here, but: the median GDP per capita is 8,108 USD and the median GDP (87 billion USD) is half the GDP of South Carolina (the 10th poorest U.S. state).",
...
tribble(
  ...
  labs(title = "The Typical Economy and Quality of Life in These Countries Are Well Below Even South Carolina (the 10th Poorest State)",
       subtitle = "The wealthiest per capita country in that list (Kuwait) would still be the poorest state in the U.S. by around 2,000 USD a head.")

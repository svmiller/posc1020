...
```{r usa-trade-gdp-1960-2018, echo=F, eval=T, fig.width = 14, fig.height = 8.5, warning = F, message = F}
...
ustrade %>%
  ...
  labs(caption = "Data: World Bank Development Indicators (1960-2016), United States Cenus Bureau (2017-18)",
       title="Trade as a Percentage of U.S. GDP, 1960-2018",
       subtitle="Trade has become an increasingly large part of the U.S. economy since the 1960s, but the value of trade to U.S. economic output is declining with the Trump presidency.")
```

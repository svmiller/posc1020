...
fredr(series_id = "EXUSEU",
  ...
  geom_rect(data=filter(recessions, year(Peak) > 1999), inherit.aes=F, aes(xmin=Peak, xmax=Trough, ymin=-Inf, ymax=+Inf), alpha=0.4) + 
  scale_x_date(date_breaks = "2 years", date_minor_breaks = "1 year", date_labels = "%Y") +
  labs(caption = "Data: Board of Governors of the Federal Reserve System (US). Shaded areas indicate U.S. recessions.",
       title = "The Euro is Usually Worth More Than the Dollar",
       subtitle = "A dollar and 15 cents bought one Euro to open 1999 and, despite obvious fluctuation, that's about the exchange rate now.")
...
```{r usa-chn-reer-1980-2017, echo=F, eval=T, fig.width = 14, fig.height = 8.5, warning = F, message = F}

WDI(country=c("CN", "US"), indicator = "PX.REX.REER", start=1980, end=2017) %>%
